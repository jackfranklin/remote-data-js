...
/***/ function(module, exports, __webpack_require__) {
	...
	var makeFetchRequest = exports.makeFetchRequest = function makeFetchRequest(remoteDataInstance, url) {
	  return fetch(url, remoteDataInstance.fetchOptions).then(checkStatus).then(parseAndKeepResponse(remoteDataInstance.parse.bind(remoteDataInstance))).then(function (_ref) {
