	...
	var RemoteData = function () {
	  function RemoteData() {
	    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	        ...
	        state = _ref$state === undefined ? _states.NOT_ASKED : _ref$state,
	  ...
	  _createClass(RemoteData, [{
	    ...
	    value: function _case(_ref2) {
	      var _ref2$NotAsked = _ref2.NotAsked,
	          NotAsked = _ref2$NotAsked === undefined ? function () {
	        return _();
	      } : _ref2$NotAsked,
	          _ref2$Pending = _ref2.Pending,
	          Pending = _ref2$Pending === undefined ? function () {
	        return _();
	      } : _ref2$Pending,
	          _ref2$Failure = _ref2.Failure,
	          Failure = _ref2$Failure === undefined ? function () {
	        return _.apply(undefined, arguments);
	      } : _ref2$Failure,
	          _ref2$Success = _ref2.Success,
	          Success = _ref2$Success === undefined ? function () {
	        return _.apply(undefined, arguments);
	      } : _ref2$Success,
	          _ref2$_ = _ref2._,
	          _ = _ref2$_ === undefined ? function () {} : _ref2$_;
